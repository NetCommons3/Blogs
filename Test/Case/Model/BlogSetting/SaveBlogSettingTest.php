<?php
/**
 * BlogSetting::saveBlogSetting()のテスト
 *
 ...
 */
class BlogSettingSaveBlogSettingTest extends NetCommonsSaveTest {
 ...
 * @var string
 */
	protected $_methodName = 'saveBlogSetting';
 ...
 */
	public function testSave($data) {
		...
		//登録データ取得
		$actual = $this->$model->getBlogSetting();
		$expected = $data;
